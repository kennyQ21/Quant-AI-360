...
from ingestion.market_data import download_and_save_stock, load_data, save_data
...
def append_new_data(symbol: str) -> bool:
    ...
    """
    try:
        from ingestion.market_data import fetch_stock_data
...
if __name__ == "__main__":
    ...
    if results["successful"]:
        logger.info("\nRebuild dataset after updates? Run: python data/build_dataset.py")
